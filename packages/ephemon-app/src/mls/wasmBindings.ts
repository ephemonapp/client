...
export type WasmMlsCommitOutcome = {
    readonly senderMemberNumber: number;
...
export type WasmMlsClient = {
    ...
    createSelfUpdate(): Uint8Array;
    processIncomingCommit(message: Uint8Array, authorizedCommitters: Uint32Array): WasmMlsCommitOutcome;
