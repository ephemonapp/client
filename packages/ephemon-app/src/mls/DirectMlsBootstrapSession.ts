...
/** Resumable two-member MLS bootstrap over an authenticated link; lost delivery is recovered by replaying the last frame. */
export class DirectMlsBootstrapSession {
    ...
    get phase(): DirectMlsBootstrapPhase {
        ...
        switch (this.companion?.kind) {
            ...
            case 'invite':
                throw new Error('An invite frame belongs to the member-add exchange, not to bootstrap');
        }
    }
